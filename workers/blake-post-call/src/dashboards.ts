...
<div class="shell">
  ...
  <header class="masthead">
    <div class="brandrow">
      ...
      <span>Updated May 23, 2026 · 12:30 AM ET</span>
    </div>
  ...
  <div class="summary-row">
      ...
      <div class="summary-kpi live"><div class="label">Overall Completion</div><p class="v">57<small>%</small></p></div>
      <div class="summary-kpi"><div class="label">Tasks Done</div><p class="v">33<small> / 57</small></p></div>
...
<li class="task" data-pillar-id="pillar-a-blake" data-task-label="Pilot 10 real outbound dials + transcript review" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Pilot 10 real outbound dials + transcript review</span></li>
    ...
    <section class="pillar">
      <div class="pillar-header">
        ...
        <div>
          <div class="progress-bar"><div class="fill" style="width:63%"></div></div>
          <div class="progress-label">7 / 11 done · 63%</div>
        </div>
      </div>
...
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Create opportunity in Realtor Listings pipeline @ &#x27;1. New Listing&#x27; with name &#x27;Address · asking $Xk → MAO $Yk&#x27;" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Create opportunity in Realtor Listings pipeline @ &#x27;1. New Listing&#x27; with name &#x27;Address · asking $Xk → MAO $Yk&#x27;</span></li>
<li class="task" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Email parser: extract address / asking / sqft / realtor info from Zillow/Redfin HTML" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Email parser: extract address / asking / sqft / realtor info from Zillow/Redfin HTML</span></li>
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="SMS realtor with offer via Twilio (needs TWILIO_ACCOUNT_SID + TWILIO_AUTH_TOKEN bound to Worker)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">SMS realtor with offer via Twilio (needs TWILIO_ACCOUNT_SID + TWILIO_AUTH_TOKEN bound to Worker)</span></li>
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Slack notify #base1-sms-leadgen (needs SLACK_BOT_TOKEN bound to Worker)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Slack notify #base1-sms-leadgen (needs SLACK_BOT_TOKEN bound to Worker)</span></li>
<li class="task" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Cloudflare Email Routing: listings@atompropertygroup.org → Worker" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Cloudflare Email Routing: listings@atompropertygroup.org → Worker</span></li>
<li class="task" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Realtor reply handler: Twilio inbound → GHL update + Slack alert" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Realtor reply handler: Twilio inbound → GHL update + Slack alert</span></li>
<li class="task" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Future: Apify/RentCast ARV integration (replace flat $30/sqft assumption)" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Future: Apify/RentCast ARV integration (replace flat $30/sqft assumption)</span></li>
      </ul>
    </section>
...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Property Group · ACQ Operations</span>
      <span>Last updated May 23, 2026 12:30 AM ET</span>
    </div>
...
<div class="container">
  ...
  <div class="status-banner failure"><div class="status-text">⚠ <strong>1 cron job(s) failed on their last run</strong> — automation is partially down.</div><a class="btn btn-edit" href="https://github.com/AtomInvestments/acq-automation/actions" target="_blank">VIEW LOGS</a></div><div class="run-grid"><div class="run-row"><span class="tag hot">FAILED</span><span class="run-name">ACQ SMS Follow-Up + Dashboard</span><span class="run-ts">May 23, 12:28 AM</span><span class="run-detail">failure — see logs</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ Call Recording Automation</span><span class="run-ts">May 22, 05:46 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">APG Slack Scraper</span><span class="run-ts">May 22, 05:51 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">Weekly Analysis</span><span class="run-ts">May 22, 12:23 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">dashboard (script)</span><span class="run-ts">May 23, 12:30 AM</span><span class="run-detail">dashboard updated</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">sms (script)</span><span class="run-ts">May 23, 12:29 AM</span><span class="run-detail">outside business hours (hour=0 ET)</span></div></div><div class="status-banner on"><div class="status-text"><span class="pulse"></span>SMS Automation: <span style="color:var(--green);font-weight:800">ACTIVE</span></div><a class="btn btn-kill" href="https://docs.google.com/spreadsheets/d/1wc3Pt46ze-ejLaryL8WIRQf4OjEkirolc4-O8lsRQZY/edit#gid=0" target="_blank">EMERGENCY KILL SWITCH</a></div>
...
<tr><td><strong>Nicole Berkovich</strong></td><td>3101 Ocean Ave</td><td><span class="tag">Dead Deals</span></td><td><span class="tag gray">DND — do not contact</span></td><td><span class="tag warm">0/6</span></td><td></td></tr></tbody></table></div>
  ...
  <section class="sec">
    ...
    <div class="lead-table"><table id="activeTable"><thead><tr><th>Contact</th><th>Address</th><th>State</th><th>Stage</th><th>SMS Sent</th><th>Last Sent</th><th>From Number</th></tr></thead><tbody><tr><td><strong>Darko Gregurovic</strong></td><td>426 N 10th St</td><td>NJ</td><td><span class="tag">1. Qualified</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
...
new Chart(document.getElementById('stateChart'), {
  type: 'bar',
  data: { labels: ["NJ", "AL", "PA", "OH", "MI", "SC"], datasets: [{ data: [45, 14, 14, 5, 1, 1], backgroundColor: '#C9A52A', borderRadius: 4 }] },
