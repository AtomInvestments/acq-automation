...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Investments · APG Operations</span>
      <span>Last updated Jul 24, 2026 01:57 PM ET</span>
    </div>
  ...
  <section class="sec">
    ...
    <hr>
    <div class="stat-row">
      <div class="stat"><div class="lab">Total Deals</div><div class="v">51</div><div class="sub">stages 1-4 (active)</div></div>
      ...
      <div class="stat"><div class="lab">Avg Call Rating</div><div class="v">5.0/10</div><div class="sub">across 8 rated calls</div></div>
      <div class="stat warm"><div class="lab">With ARV calculated</div><div class="v">18</div><div class="sub">/ 51 deals</div></div>
...
<div class="container">
  ...
  <div class="status-banner failure"><div class="status-text">⚠ <strong>2 cron job(s) failed on their last run</strong> — automation is partially down.</div><a class="btn btn-edit" href="https://github.com/AtomInvestments/acq-automation/actions" target="_blank">VIEW LOGS</a></div><div class="run-grid"><div class="run-row"><span class="tag hot">FAILED</span><span class="run-name">ACQ SMS Follow-Up + Dashboard</span><span class="run-ts">Jul 24, 12:26 PM</span><span class="run-detail">failure — see logs</span></div><div class="run-row"><span class="tag hot">FAILED</span><span class="run-name">APG Slack Scraper</span><span class="run-ts">Jul 24, 12:26 PM</span><span class="run-detail">failure — see logs</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ Call Recording Automation</span><span class="run-ts">Jul 24, 01:48 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">Weekly Analysis</span><span class="run-ts">Jul 24, 11:27 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">dashboard (script)</span><span class="run-ts">Jul 24, 01:57 PM</span><span class="run-detail">dashboard updated</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">sms (script)</span><span class="run-ts">Jul 24, 01:56 PM</span><span class="run-detail">{&quot;wait&quot;: 33, &quot;no-phone&quot;: 2, &quot;skipped-tag-prebail&quot;: 57, &quot;skipped&quot;: 7}</span></div></div><div class="status-banner on"><div class="status-text"><span class="pulse"></span>SMS Automation: <span style="color:var(--green);font-weight:800">ACTIVE</span></div><a class="btn btn-kill" href="https://docs.google.com/spreadsheets/d/1wc3Pt46ze-ejLaryL8WIRQf4OjEkirolc4-O8lsRQZY/edit#gid=0" target="_blank">EMERGENCY KILL SWITCH</a></div>

  <section class="sec">
    <div class="tag-row"><span class="num">01</span><h2>At a Glance</h2></div>
    <hr>
    <div class="stat-row">
      <div class="stat"><div class="lab">Total Leads</div><div class="v">99</div><div class="sub">across all stages</div></div>
      <div class="stat"><div class="lab">In Sequence</div><div class="v">35</div><div class="sub">SMS scheduled</div></div>
      ...
      <div class="stat green"><div class="lab">Reply Rate</div><div class="v">61.3%</div><div class="sub">replied / total touched</div></div>
    </div>
  </section>
...
<tr><td><strong>Corey Delp</strong></td><td>10 Bay Ave</td><td><span class="tag">Follow Up 3mo</span></td><td><span class="tag hot">Jun 24, 07:30 PM</span></td><td></td></tr>
...
<tr><td><strong>Harinder Gill</strong></td><td>6 Parrotta Dr</td><td><span class="tag">Dead Deals</span></td><td><span class="tag hot"></span></td><td></td></tr></tbody></table></div>
  ...
  <section class="sec">
    ...
    <div class="lead-table"><table><thead><tr><th>Contact</th><th>Address</th><th>Stage</th><th>Reason</th><th>SMS Sent</th><th>Last Sent</th></tr></thead><tbody><tr><td><strong>Beata Szyffer-Hopkins</strong></td><td>412 Neadow Woods lane</td><td><span class="tag">3. Due Diligence</span></td><td><span class="tag warm">6 SMS no reply — call manually</span></td><td><span class="tag warm">6/6</span></td><td>Jun 20, 12:57 PM</td></tr></tbody></table></div>
  </section>
...
<tr><td><strong>Nicole Berkovich</strong></td><td>3101 Ocean Ave</td><td><span class="tag">Dead Deals</span></td><td><span class="tag gray">DND — do not contact</span></td><td><span class="tag warm">0/6</span></td><td></td></tr></tbody></table></div>
  ...
  <section class="sec">
    ...
    <div class="lead-table"><table id="activeTable"><thead><tr><th>Contact</th><th>Address</th><th>State</th><th>Stage</th><th>SMS Sent</th><th>Last Sent</th><th>From Number</th></tr></thead><tbody><tr><td><strong>Mido (Realtor Test)</strong></td><td>PLEASANTVILLE</td><td>NJ</td><td><span class="tag">1. Qualified</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
<tr><td><strong>Juan Marin</strong></td><td>40 Farnham Ave</td><td>NJ</td><td><span class="tag">1. Qualified</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
...
<tr><td><strong>Mason Hahn</strong></td><td>202 Grant Ave</td><td>NJ</td><td><span class="tag">Follow Up 1.5mo</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
<tr><td><strong>Kulila | Zyre Austin</strong></td><td>6952 Casale Blvd</td><td>NJ</td><td><span class="tag">Follow Up 1.5mo</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
<tr><td><strong>Kenneth Bajek</strong></td><td>406 Adeline St</td><td>NJ</td><td><span class="tag">Follow Up 1.5mo</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
...
<tr><td><strong>Linda Charles</strong></td><td>450 Seven Oaks Rd</td><td>NJ</td><td><span class="tag">Follow Up 1.5mo</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
<tr><td><strong>Joshua Ostrin</strong></td><td>33 S 1st Ave</td><td>NJ</td><td><span class="tag">Follow Up 1.5mo</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
<tr><td><strong>Deborah Ides</strong></td><td>48 Church St # 50</td><td>NJ</td><td><span class="tag">Follow Up 1.5mo</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
...
<tr><td><strong>Vance Stephens</strong></td><td>32 Cavell St</td><td>NJ</td><td><span class="tag">Follow Up 1.5mo</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
<tr><td><strong>Venkata Bandaru</strong></td><td>35 George Davison Rd</td><td>NJ</td><td><span class="tag">Follow Up 1.5mo</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
...
<tr><td><strong>Kulila | Zyre Austin</strong></td><td>6952 Casale Blvd</td><td>FUP - see if Open to Listing</td><td><span class="tag">Jeff</span></td><td>Feb 16, 05:00 PM</td></tr>
...
new Chart(document.getElementById('stageChart'), {
  type: 'doughnut',
  data: { labels: ["1. Qualified", "2. LAO", "3. Due Diligence", "4. MAO", "Follow Up 1.5mo", "Follow Up 3mo", "Dead Deals"], datasets: [{ data: [32, 5, 6, 4, 19, 3, 30], backgroundColor: palette, borderWidth: 2, borderColor: '#FFFCF4' }] },
  options: { plugins: { legend: { position: 'bottom', labels: { padding: 12, usePointStyle: true, color: '#455066' } } }, cutout: '65%' }
});

new Chart(document.getElementById('stateChart'), {
  type: 'bar',
  data: { labels: ["NJ", "AL", "PA", "OH", "UNKNOWN", "MI", "SC"], datasets: [{ data: [62, 14, 13, 5, 3, 1, 1], backgroundColor: '#C9A52A', borderRadius: 4 }] },
...
new Chart(document.getElementById('progressChart'), {
  type: 'bar',
  data: { labels: ['0','1','2','3','4','5','6'], datasets: [{ label: 'Contacts', data: [62, 26, 5, 1, 3, 1, 1], backgroundColor: '#1A2840', borderRadius: 4 }] },
  options: { plugins: { legend: { display: false } }, scales: { y: { beginAtZero: true, ticks: { precision: 0, color: '#6B7591' }, grid: { color: 'rgba(26,40,64,0.06)' } }, x: { ticks: { color: '#455066' }, grid: { display: false } } } }
});

new Chart(document.getElementById('numberChart'), {
  type: 'bar',
  data: { labels: ["Jeff (NJ)", "PA Market", "AL Market", "OH Market"], datasets: [{ data: [21, 7, 7, 2], backgroundColor: palette, borderRadius: 4 }] },
