...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Investments · APG Operations</span>
      <span>Last updated Jul 07, 2026 09:18 PM ET</span>
    </div>
  ...
  <section class="sec">
    ...
    <hr>
    <div class="stat-row">
      <div class="stat"><div class="lab">Total Deals</div><div class="v">14</div><div class="sub">stages 1-4 (active)</div></div>
      ...
      <div class="stat"><div class="lab">Avg Call Rating</div><div class="v">6.0/10</div><div class="sub">across 2 rated calls</div></div>
      <div class="stat warm"><div class="lab">With ARV calculated</div><div class="v">6</div><div class="sub">/ 14 deals</div></div>
...
<div class="container">
  ...
  <details class="run-grid-collapsed"><summary>All 5 cron jobs OK on last run — click for timestamps</summary><div class="run-grid"><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ Call Recording Automation</span><span class="run-ts">Jul 07, 09:12 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ SMS Follow-Up + Dashboard</span><span class="run-ts">Jul 07, 07:44 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">APG Slack Scraper</span><span class="run-ts">Jul 07, 07:44 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">dashboard (script)</span><span class="run-ts">Jul 07, 09:18 PM</span><span class="run-detail">dashboard updated</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">sms (script)</span><span class="run-ts">Jul 07, 09:17 PM</span><span class="run-detail">outside business hours (hour=21 ET)</span></div></div></details><div class="status-banner on"><div class="status-text"><span class="pulse"></span>SMS Automation: <span style="color:var(--green);font-weight:800">ACTIVE</span></div><a class="btn btn-kill" href="https://docs.google.com/spreadsheets/d/1wc3Pt46ze-ejLaryL8WIRQf4OjEkirolc4-O8lsRQZY/edit#gid=0" target="_blank">EMERGENCY KILL SWITCH</a></div>
...
<tr><td><strong>(no name)</strong></td><td></td><td><span class="tag">3. Due Diligence</span></td><td><span class="tag hot"></span></td><td>Jeff (NJ)</td></tr>
<tr><td><strong>(no name)</strong></td><td></td><td><span class="tag">4. MAO</span></td><td><span class="tag hot"></span></td><td>OH Market</td></tr>
<tr><td><strong>(no name)</strong></td><td></td><td><span class="tag">4. MAO</span></td><td><span class="tag hot"></span></td><td>PA Market</td></tr>
<tr><td><strong>(no name)</strong></td><td></td><td><span class="tag">4. MAO</span></td><td><span class="tag hot"></span></td><td>AL Market</td></tr>
<tr><td><strong>(no name)</strong></td><td></td><td><span class="tag">4. MAO</span></td><td><span class="tag hot">May 09, 07:51 AM</span></td><td></td></tr>
...
new Chart(document.getElementById('stateChart'), {
  type: 'bar',
  data: { labels: ["NJ", "UNKNOWN", "AL", "PA", "OH", "MI"], datasets: [{ data: [49, 22, 12, 7, 3, 1], backgroundColor: '#C9A52A', borderRadius: 4 }] },
