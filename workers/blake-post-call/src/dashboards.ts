...
<div class="shell">
  ...
  <header class="masthead">
    <div class="brandrow">
      ...
      <span>Updated May 23, 2026 · 03:40 AM ET</span>
    </div>
...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Property Group · ACQ Operations</span>
      <span>Last updated May 23, 2026 03:40 AM ET</span>
    </div>
...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Property Group · ACQ Operations</span>
      <span>Last updated May 23, 2026 03:39 AM ET</span>
    </div>
  ...
  <details class="run-grid-collapsed"><summary>All 6 cron jobs OK on last run — click for timestamps</summary><div class="run-grid"><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ Call Recording Automation</span><span class="run-ts">May 22, 05:46 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ SMS Follow-Up + Dashboard</span><span class="run-ts">May 23, 12:31 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">APG Slack Scraper</span><span class="run-ts">May 22, 05:51 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">Weekly Analysis</span><span class="run-ts">May 22, 12:23 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">dashboard (script)</span><span class="run-ts">May 23, 03:39 AM</span><span class="run-detail">dashboard updated</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">sms (script)</span><span class="run-ts">May 23, 03:39 AM</span><span class="run-detail">outside business hours (hour=3 ET)</span></div></div></details><div class="status-banner on"><div class="status-text"><span class="pulse"></span>SMS Automation: <span style="color:var(--green);font-weight:800">ACTIVE</span></div><a class="btn btn-kill" href="https://docs.google.com/spreadsheets/d/1wc3Pt46ze-ejLaryL8WIRQf4OjEkirolc4-O8lsRQZY/edit#gid=0" target="_blank">EMERGENCY KILL SWITCH</a></div>
...
<tr><td><strong>(no name)</strong></td><td></td><td></td><td><span class="tag">Follow Up 1.5mo</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
<tr><td><strong>(no name)</strong></td><td></td><td></td><td><span class="tag">Follow Up 3mo</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
...
new Chart(document.getElementById('stateChart'), {
  type: 'bar',
  data: { labels: ["NJ", "PA", "UNKNOWN", "AL", "OH", "MI", "SC"], datasets: [{ data: [35, 13, 13, 12, 5, 1, 1], backgroundColor: '#C9A52A', borderRadius: 4 }] },
