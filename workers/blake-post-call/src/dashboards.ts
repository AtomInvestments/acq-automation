...
<div class="shell">
  ...
  <header class="masthead">
    <div class="brandrow">
      ...
      <span>Updated May 24, 2026 · 03:05 PM ET</span>
    </div>
  ...
  <div class="summary-row">
      ...
      <div class="summary-kpi live"><div class="label">Overall Completion</div><p class="v">63<small>%</small></p></div>
      <div class="summary-kpi"><div class="label">Tasks Done</div><p class="v">38<small> / 60</small></p></div>
      <div class="summary-kpi live"><div class="label">Active Pillars</div><p class="v">3</p></div>
    ...
    <section class="pillar">
      <div class="pillar-header">
        ...
        <div>
          ...
          <div class="progress-label">16 / 19 done · 84%</div>
        </div>
      </div>
...
<li class="task done" data-pillar-id="pillar-a-blake" data-task-label="Post-call structured extractor (Claude) → auto-writes address / lead temp / RJ task / opportunity stage" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Post-call structured extractor (Claude) → auto-writes address / lead temp / RJ task / opportunity stage</span></li>
<li class="task done" data-pillar-id="pillar-a-blake" data-task-label="Auto-create opportunity in ACQ pipeline with APG-format name &#x27;Name / Address / Phone&#x27;" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Auto-create opportunity in ACQ pipeline with APG-format name &#x27;Name / Address / Phone&#x27;</span></li>
<li class="task done" data-pillar-id="pillar-a-blake" data-task-label="Voice prompt v1.3 (no narration / read Seller File / end-call confirmation read-back)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Voice prompt v1.3 (no narration / read Seller File / end-call confirmation read-back)</span></li>
...
<li class="task done" data-pillar-id="pillar-a-blake" data-task-label="Live dashboard at /blake.html (Worker /dashboard-data, 10-sec polling)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Live dashboard at /blake.html (Worker /dashboard-data, 10-sec polling)</span></li>
<li class="task" data-pillar-id="pillar-a-blake" data-task-label="Adam records 30-min voice clone session (hard gate before scaling)" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Adam records 30-min voice clone session (hard gate before scaling)</span></li>
    ...
    <section class="pillar">
      <div class="pillar-header">
        ...
        <div>
          ...
          <div class="progress-label">12 / 14 done · 85%</div>
        </div>
      </div>
      <p class="summary">Email-driven realtor outreach. Zillow/Redfin listing arrives → n8n forwards to Worker → parse + single-family + NJ/PA filter → Claude web_fetch finds the agent → MAO calc → opp in Realtor Listings pipeline → SMS from Blake to agent → Slack alert in #listed-leads.</p>
      <ul class="tasks">
...
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Create opportunity in Realtor Listings @ &#x27;1. New Listing&#x27; (naming: Agent / Address / Phone, dedup by address)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Create opportunity in Realtor Listings @ &#x27;1. New Listing&#x27; (naming: Agent / Address / Phone, dedup by address)</span></li>
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Email parser: pull address / asking / sqft / beds / baths / listing URL from Zillow/Redfin HTML (subject-priority, footer blacklist)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Email parser: pull address / asking / sqft / beds / baths / listing URL from Zillow/Redfin HTML (subject-priority, footer blacklist)</span></li>
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="SMS realtor — routed through GHL Conversations API (uses GHL +1 609-699-8437, not Blake&#x27;s voice number)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">SMS realtor — routed through GHL Conversations API (uses GHL +1 609-699-8437, not Blake&#x27;s voice number)</span></li>
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Slack notify #listed-leads on every accepted listing (with full MAO breakdown + agent contact)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Slack notify #listed-leads on every accepted listing (with full MAO breakdown + agent contact)</span></li>
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Gmail → Worker bridge (n8n Cloud workflow, polls listing-alert label every 1 min, active)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Gmail → Worker bridge (n8n Cloud workflow, polls listing-alert label every 1 min, active)</span></li>
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Listing-agent lookup via Claude web_fetch (fills agent name + phone + brokerage when email omits them)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Listing-agent lookup via Claude web_fetch (fills agent name + phone + brokerage when email omits them)</span></li>
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Single-family-only filter (skip townhouse / condo / multi-family / manufactured)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Single-family-only filter (skip townhouse / condo / multi-family / manufactured)</span></li>
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="SMS message rewritten as human Blake outreach (3 rotating variants, signed as Blake at APG, not a corporate template)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">SMS message rewritten as human Blake outreach (3 rotating variants, signed as Blake at APG, not a corporate template)</span></li>
<li class="task" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Realtor SMS reply handler: realtor replies in GHL conversation → auto-thread reply on the original #listed-leads Slack alert + bump opp stage" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Realtor SMS reply handler: realtor replies in GHL conversation → auto-thread reply on the original #listed-leads Slack alert + bump opp stage</span></li>
<li class="task" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Future: Apify / RentCast ARV integration (replace flat $30/sqft assumption with real comp data)" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Future: Apify / RentCast ARV integration (replace flat $30/sqft assumption with real comp data)</span></li>
      </ul>
    </section>
    ...
    <section class="pillar">
      ...
      <ul class="tasks">
        <li class="task" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="Vault sync: every Blake conversation → APG-Vault markdown" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Vault sync: every Blake conversation → APG-Vault markdown</span></li>
<li class="task" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="Vault sync: every SmarterContact thread → vault" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Vault sync: every SmarterContact thread → vault</span></li>
<li class="task" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="Vault sync: every #base1-sms-leadgen Slack message → vault" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Vault sync: every #base1-sms-leadgen Slack message → vault</span></li>
<li class="task" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="Self-improvement trigger: fire on 50+ new transcripts" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Self-improvement trigger: fire on 50+ new transcripts</span></li>
<li class="task" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="Claude prompt-iteration loop: draft new Blake version" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Claude prompt-iteration loop: draft new Blake version</span></li>
<li class="task" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="A/B test infrastructure: 20-30% of calls on new version" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">A/B test infrastructure: 20-30% of calls on new version</span></li>
<li class="task" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="Auto-promote winning version" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Auto-promote winning version</span></li>
<li class="task" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="Daily Slack summary of Blake calls" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Daily Slack summary of Blake calls</span></li>
      </ul>
    </section>
...
<li class="task done" data-pillar-id="infrastructure" data-task-label="CF Workers Builds → auto-deploy on push" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">CF Workers Builds → auto-deploy on push</span></li>
<li class="task done" data-pillar-id="infrastructure" data-task-label="CF Worker secrets: BLAKE_GHL_PIT, ELEVENLABS_API_KEY, ELEVENLABS_WEBHOOK_SECRET, ANTHROPIC_API_KEY" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">CF Worker secrets: BLAKE_GHL_PIT, ELEVENLABS_API_KEY, ELEVENLABS_WEBHOOK_SECRET, ANTHROPIC_API_KEY</span></li>
<li class="task done" data-pillar-id="infrastructure" data-task-label="DIAL_STATE KV namespace for warm-up + dedupe" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">DIAL_STATE KV namespace for warm-up + dedupe</span></li>
...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Property Group · ACQ Operations</span>
      <span>Last updated May 24, 2026 03:05 PM ET</span>
    </div>
  ...
  <section class="sec">
    ...
    <div class="stat-row">
      ...
      <div class="stat warm"><div class="lab">With ARV calculated</div><div class="v">9</div><div class="sub">/ 39 deals</div></div>
...
<div class="container">
  ...
  <details class="run-grid-collapsed"><summary>All 6 cron jobs OK on last run — click for timestamps</summary><div class="run-grid"><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ Call Recording Automation</span><span class="run-ts">May 24, 11:48 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ SMS Follow-Up + Dashboard</span><span class="run-ts">May 24, 12:14 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">APG Slack Scraper</span><span class="run-ts">May 24, 12:21 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">Market Analysis Refresh</span><span class="run-ts">May 24, 06:44 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">dashboard (script)</span><span class="run-ts">May 24, 03:05 PM</span><span class="run-detail">dashboard updated</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">sms (script)</span><span class="run-ts">May 24, 03:05 PM</span><span class="run-detail">{&quot;skipped-tag-prebail&quot;: 55, &quot;wait&quot;: 18, &quot;skipped&quot;: 5, &quot;replied-neutral&quot;: 1, &quot;no-phone&quot;: 1}</span></div></div></details><div class="status-banner on"><div class="status-text"><span class="pulse"></span>SMS Automation: <span style="color:var(--green);font-weight:800">ACTIVE</span></div><a class="btn btn-kill" href="https://docs.google.com/spreadsheets/d/1wc3Pt46ze-ejLaryL8WIRQf4OjEkirolc4-O8lsRQZY/edit#gid=0" target="_blank">EMERGENCY KILL SWITCH</a></div>
  ...
  <section class="sec">
    ...
    <div class="stat-row">
      ...
      <div class="stat green"><div class="lab">Reply Rate</div><div class="v">74.7%</div><div class="sub">replied / total touched</div></div>
    </div>
  </section>
...
<tr><td><strong>Doris / Marlin Smith</strong></td><td>4704 9th Ave</td><td><span class="tag">Follow Up 1.5mo</span></td><td><span class="tag hot">Apr 29, 01:53 PM</span></td><td></td></tr>
...
<tr><td><strong>Nicole Berkovich</strong></td><td>3101 Ocean Ave</td><td><span class="tag">Dead Deals</span></td><td><span class="tag gray">DND — do not contact</span></td><td><span class="tag warm">0/6</span></td><td></td></tr></tbody></table></div>
  ...
  <section class="sec">
    ...
    <div class="lead-table"><table id="activeTable"><thead><tr><th>Contact</th><th>Address</th><th>State</th><th>Stage</th><th>SMS Sent</th><th>Last Sent</th><th>From Number</th></tr></thead><tbody><tr><td><strong>Melvin W Staples</strong></td><td>3712 41st Ave N</td><td>AL</td><td><span class="tag">1. Qualified</span></td><td><span class="tag green">2</span></td><td>May 22, 01:08 PM</td><td>AL Market</td></tr>
...
<tr><td><strong>Christopher Smith</strong></td><td>1639 Levity St</td><td>SC</td><td><span class="tag">Dead Deals</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr></tbody></table></div>
  ...
  <section class="sec">
    ...
    <hr>
    <div class="lead-table"><table><thead><tr><th>Contact</th><th>Address</th><th>Task</th><th>Assignee</th><th>Due</th></tr></thead><tbody><tr><td><strong>Joseph Schili</strong></td><td>1370 Oriental Ave</td><td>REVIEW: Did Jeff call Joseph Schili? (Gloucester City)</td><td><span class="tag">Mike</span></td><td>May 11, 10:36 AM</td></tr>
...
<tr><td><strong>Doris / Marlin Smith</strong></td><td>4704 9th Ave</td><td>REVIEW: Did Jeff call Doris / Marlin Smith back?</td><td><span class="tag">Mike</span></td><td>May 25, 03:04 PM</td></tr>
<tr><td><strong>Doris / Marlin Smith</strong></td><td>4704 9th Ave</td><td>Call back: Doris / Marlin Smith (4704 9th Ave)</td><td><span class="tag">Jeff</span></td><td>May 24, 03:04 PM</td></tr>
...
new Chart(document.getElementById('stageChart'), {
  type: 'doughnut',
  data: { labels: ["1. Qualified", "2. LAO", "3. Due Diligence", "4. MAO", "Follow Up 1.5mo", "Follow Up 3mo", "Dead Deals"], datasets: [{ data: [19, 5, 7, 5, 11, 2, 31], backgroundColor: palette, borderWidth: 2, borderColor: '#FFFCF4' }] },
