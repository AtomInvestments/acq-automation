...
<div class="shell">
  ...
  <header class="masthead">
    <div class="brandrow">
      ...
      <span>Updated Jun 09, 2026 · 07:54 PM ET</span>
    </div>
...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Property Group · ACQ Operations</span>
      <span>Last updated Jun 09, 2026 07:54 PM ET</span>
    </div>
...
<div class="container">
  ...
  <details class="run-grid-collapsed"><summary>All 6 cron jobs OK on last run — click for timestamps</summary><div class="run-grid"><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ Call Recording Automation</span><span class="run-ts">Jun 09, 07:05 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ SMS Follow-Up + Dashboard</span><span class="run-ts">Jun 09, 05:03 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">APG Slack Scraper</span><span class="run-ts">Jun 09, 02:34 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">Market Analysis Refresh</span><span class="run-ts">Jun 07, 11:12 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">dashboard (script)</span><span class="run-ts">Jun 09, 07:54 PM</span><span class="run-detail">dashboard updated</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">sms (script)</span><span class="run-ts">Jun 09, 07:54 PM</span><span class="run-detail">{&quot;skipped-tag-prebail&quot;: 57, &quot;skipped&quot;: 5, &quot;wait&quot;: 15, &quot;no-phone&quot;: 1}</span></div></div></details><div class="status-banner on"><div class="status-text"><span class="pulse"></span>SMS Automation: <span style="color:var(--green);font-weight:800">ACTIVE</span></div><a class="btn btn-kill" href="https://docs.google.com/spreadsheets/d/1wc3Pt46ze-ejLaryL8WIRQf4OjEkirolc4-O8lsRQZY/edit#gid=0" target="_blank">EMERGENCY KILL SWITCH</a></div>
...
<div class="shell">
  ...
  <div class="paused-banner">SMS sends are <strong>PAUSED</strong> per APG Q2 strategy. Test infrastructure is fully wired — variant assignment, outcome tracking, and dashboard rendering all run. Flip <code>o2_test_config.json::global.sms_paused</code> to <code>false</code> to begin firing sends. Variant assignments computed during the pause are deterministic and survive the flip.</div>
    ...
    <div class="sig">
      ...
      <table class="sig-table">
        ...
        <tbody><tr><td><strong>A</strong></td><td>34.1%</td><td>33.6%</td></tr><tr><td><strong>B</strong></td><td>32.1%</td><td>32.3%</td></tr><tr><td><strong>C</strong></td><td>33.9%</td><td>34.1%</td></tr></tbody>
      </table>
  ...
  <div class="foot">Generated 2026-06-09T23:54:59.375347+00:00 · sms_test_dashboard.py</div>
</div>
</body>
</html>`,
