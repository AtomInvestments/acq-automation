...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Investments · APG Operations</span>
      <span>Last updated Aug 02, 2026 12:44 PM ET</span>
    </div>
...
<div class="container">
  ...
  <div class="status-banner failure"><div class="status-text">⚠ <strong>1 cron job(s) failed on their last run</strong> — automation is partially down.</div><a class="btn btn-edit" href="https://github.com/AtomInvestments/acq-automation/actions" target="_blank">VIEW LOGS</a></div><div class="run-grid"><div class="run-row"><span class="tag hot">FAILED</span><span class="run-name">ACQ SMS Follow-Up + Dashboard</span><span class="run-ts">Aug 02, 11:36 AM</span><span class="run-detail">failure — see logs</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ Call Recording Automation</span><span class="run-ts">Aug 02, 12:35 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">APG Slack Scraper</span><span class="run-ts">Aug 02, 11:52 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">Market Analysis Refresh</span><span class="run-ts">Aug 02, 06:43 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">dashboard (script)</span><span class="run-ts">Aug 02, 12:43 PM</span><span class="run-detail">dashboard updated</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">sms (script)</span><span class="run-ts">Aug 02, 12:43 PM</span><span class="run-detail">{&quot;wait&quot;: 63, &quot;no-phone&quot;: 2, &quot;skipped-tag-prebail&quot;: 81, &quot;skipped&quot;: 12}</span></div></div><div class="status-banner on"><div class="status-text"><span class="pulse"></span>SMS Automation: <span style="color:var(--green);font-weight:800">ACTIVE</span></div><a class="btn btn-kill" href="https://docs.google.com/spreadsheets/d/1wc3Pt46ze-ejLaryL8WIRQf4OjEkirolc4-O8lsRQZY/edit#gid=0" target="_blank">EMERGENCY KILL SWITCH</a></div>
