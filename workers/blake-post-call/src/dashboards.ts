...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Investments · APG Operations</span>
      <span>Last updated Jun 24, 2026 02:16 PM ET</span>
    </div>
...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Investments · APG Operations</span>
      <span>Last updated Jun 24, 2026 02:15 PM ET</span>
    </div>
  ...
  <details class="run-grid-collapsed"><summary>All 5 cron jobs OK on last run — click for timestamps</summary><div class="run-grid"><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ Call Recording Automation</span><span class="run-ts">Jun 24, 01:54 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ SMS Follow-Up + Dashboard</span><span class="run-ts">Jun 24, 12:15 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">APG Slack Scraper</span><span class="run-ts">Jun 24, 12:15 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">dashboard (script)</span><span class="run-ts">Jun 24, 02:15 PM</span><span class="run-detail">dashboard updated</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">sms (script)</span><span class="run-ts">Jun 24, 02:15 PM</span><span class="run-detail">{&quot;wait&quot;: 21, &quot;replied-neutral&quot;: 1, &quot;skipped&quot;: 7, &quot;skipped-tag-prebail&quot;: 51, &quot;no-phone&quot;: 1}</span></div></div></details><div class="status-banner on"><div class="status-text"><span class="pulse"></span>SMS Automation: <span style="color:var(--green);font-weight:800">ACTIVE</span></div><a class="btn btn-kill" href="https://docs.google.com/spreadsheets/d/1wc3Pt46ze-ejLaryL8WIRQf4OjEkirolc4-O8lsRQZY/edit#gid=0" target="_blank">EMERGENCY KILL SWITCH</a></div>

  <section class="sec">
    <div class="tag-row"><span class="num">01</span><h2>At a Glance</h2></div>
    <hr>
    <div class="stat-row">
      <div class="stat"><div class="lab">Total Leads</div><div class="v">81</div><div class="sub">across all stages</div></div>
      <div class="stat"><div class="lab">In Sequence</div><div class="v">22</div><div class="sub">SMS scheduled</div></div>
      <div class="stat hot"><div class="lab">Replied — Call Now</div><div class="v">52</div><div class="sub">Jeff has tasks</div></div>
      ...
      <div class="stat green"><div class="lab">Reply Rate</div><div class="v">69.3%</div><div class="sub">replied / total touched</div></div>
    </div>
  </section>
...
new Chart(document.getElementById('stageChart'), {
  type: 'doughnut',
  data: { labels: ["1. Qualified", "2. LAO", "3. Due Diligence", "4. MAO", "Follow Up 1.5mo", "Follow Up 3mo", "Dead Deals"], datasets: [{ data: [27, 5, 6, 5, 8, 1, 29], backgroundColor: palette, borderWidth: 2, borderColor: '#FFFCF4' }] },
  options: { plugins: { legend: { position: 'bottom', labels: { padding: 12, usePointStyle: true, color: '#455066' } } }, cutout: '65%' }
});

new Chart(document.getElementById('stateChart'), {
  type: 'bar',
  data: { labels: ["NJ", "AL", "PA", "OH", "MI", "SC"], datasets: [{ data: [47, 14, 13, 5, 1, 1], backgroundColor: '#C9A52A', borderRadius: 4 }] },
...
new Chart(document.getElementById('progressChart'), {
  type: 'bar',
  data: { labels: ['0','1','2','3','4','5','6'], datasets: [{ label: 'Contacts', data: [51, 28, 1, 0, 0, 0, 1], backgroundColor: '#1A2840', borderRadius: 4 }] },
  options: { plugins: { legend: { display: false } }, scales: { y: { beginAtZero: true, ticks: { precision: 0, color: '#6B7591' }, grid: { color: 'rgba(26,40,64,0.06)' } }, x: { ticks: { color: '#455066' }, grid: { display: false } } } }
});
