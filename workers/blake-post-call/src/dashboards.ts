...
<div class="shell">
  ...
  <header class="masthead">
    <div class="brandrow">
      ...
      <span>Updated Jun 10, 2026 · 08:40 AM ET</span>
    </div>
...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Property Group · ACQ Operations</span>
      <span>Last updated Jun 10, 2026 08:40 AM ET</span>
    </div>
  ...
  <section class="sec">
    ...
    <hr>
    <div class="stat-row">
      <div class="stat"><div class="lab">Total Deals</div><div class="v">40</div><div class="sub">stages 1-4 (active)</div></div>
      ...
      <div class="stat warm"><div class="lab">With ARV calculated</div><div class="v">9</div><div class="sub">/ 40 deals</div></div>
...
<div class="container">
  ...
  <details class="run-grid-collapsed"><summary>All 6 cron jobs OK on last run — click for timestamps</summary><div class="run-grid"><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ Call Recording Automation</span><span class="run-ts">Jun 10, 07:57 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ SMS Follow-Up + Dashboard</span><span class="run-ts">Jun 09, 07:55 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">APG Slack Scraper</span><span class="run-ts">Jun 09, 07:54 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">Market Analysis Refresh</span><span class="run-ts">Jun 07, 11:12 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">dashboard (script)</span><span class="run-ts">Jun 10, 08:39 AM</span><span class="run-detail">dashboard updated</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">sms (script)</span><span class="run-ts">Jun 10, 08:39 AM</span><span class="run-detail">outside business hours (hour=8 ET)</span></div></div></details><div class="status-banner on"><div class="status-text"><span class="pulse"></span>SMS Automation: <span style="color:var(--green);font-weight:800">ACTIVE</span></div><a class="btn btn-kill" href="https://docs.google.com/spreadsheets/d/1wc3Pt46ze-ejLaryL8WIRQf4OjEkirolc4-O8lsRQZY/edit#gid=0" target="_blank">EMERGENCY KILL SWITCH</a></div>
...
new Chart(document.getElementById('stateChart'), {
  type: 'bar',
  data: { labels: ["NJ", "AL", "PA", "OH", "MI", "UNKNOWN", "SC"], datasets: [{ data: [44, 14, 12, 5, 1, 1, 1], backgroundColor: '#C9A52A', borderRadius: 4 }] },
...
<div class="shell">
  ...
  <div class="paused-banner">SMS sends are <strong>PAUSED</strong> per APG Q2 strategy. Test infrastructure is fully wired — variant assignment, outcome tracking, and dashboard rendering all run. Flip <code>o2_test_config.json::global.sms_paused</code> to <code>false</code> to begin firing sends. Variant assignments computed during the pause are deterministic and survive the flip.</div>
    ...
    <div class="sig">
      ...
      <table class="sig-table">
        ...
        <tbody><tr><td><strong>A</strong></td><td>34.1%</td><td>33.2%</td></tr><tr><td><strong>B</strong></td><td>32.4%</td><td>33.3%</td></tr><tr><td><strong>C</strong></td><td>33.5%</td><td>33.5%</td></tr></tbody>
      </table>
  ...
  <div class="foot">Generated 2026-06-10T12:40:35.614106+00:00 · sms_test_dashboard.py</div>
</div>
</body>
</html>`,
