...
<div class="shell">
  ...
  <header class="masthead">
    <div class="brandrow">
      ...
      <span>Updated Jun 10, 2026 · 05:29 PM ET</span>
    </div>
...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Property Group · ACQ Operations</span>
      <span>Last updated Jun 10, 2026 05:29 PM ET</span>
    </div>
...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Property Group · ACQ Operations</span>
      <span>Last updated Jun 10, 2026 05:28 PM ET</span>
    </div>
  ...
  <details class="run-grid-collapsed"><summary>All 5 cron jobs OK on last run — click for timestamps</summary><div class="run-grid"><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ Call Recording Automation</span><span class="run-ts">Jun 10, 05:23 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ SMS Follow-Up + Dashboard</span><span class="run-ts">Jun 10, 08:40 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">APG Slack Scraper</span><span class="run-ts">Jun 10, 08:40 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">dashboard (script)</span><span class="run-ts">Jun 10, 05:28 PM</span><span class="run-detail">dashboard updated</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">sms (script)</span><span class="run-ts">Jun 10, 05:28 PM</span><span class="run-detail">{&quot;wait&quot;: 16, &quot;skipped-tag-prebail&quot;: 57, &quot;skipped&quot;: 5, &quot;no-phone&quot;: 1}</span></div></div></details><div class="status-banner on"><div class="status-text"><span class="pulse"></span>SMS Automation: <span style="color:var(--green);font-weight:800">ACTIVE</span></div><a class="btn btn-kill" href="https://docs.google.com/spreadsheets/d/1wc3Pt46ze-ejLaryL8WIRQf4OjEkirolc4-O8lsRQZY/edit#gid=0" target="_blank">EMERGENCY KILL SWITCH</a></div>
  ...
  <section class="sec">
    ...
    <div class="stat-row">
      ...
      <div class="stat green"><div class="lab">Reply Rate</div><div class="v">77.0%</div><div class="sub">replied / total touched</div></div>
    </div>
  </section>
...
<tr><td><strong>Nicole Berkovich</strong></td><td>3101 Ocean Ave</td><td><span class="tag">Dead Deals</span></td><td><span class="tag gray">DND — do not contact</span></td><td><span class="tag warm">0/6</span></td><td></td></tr></tbody></table></div>
  ...
  <section class="sec">
    ...
    <div class="lead-table"><table id="activeTable"><thead><tr><th>Contact</th><th>Address</th><th>State</th><th>Stage</th><th>SMS Sent</th><th>Last Sent</th><th>From Number</th></tr></thead><tbody><tr><td><strong>Mlm-Property Group Llc</strong></td><td>121 77TH ST</td><td>NJ</td><td><span class="tag">1. Qualified</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr>
<tr><td><strong>Beata Szyffer-Hopkins</strong></td><td>412 Neadow Woods lane</td><td>NJ</td><td><span class="tag">3. Due Diligence</span></td><td><span class="tag green">4</span></td><td>Jun 05, 06:44 PM</td><td>PA Market</td></tr>
...
<tr><td><strong>Christopher Smith</strong></td><td>1639 Levity St</td><td>SC</td><td><span class="tag">Dead Deals</span></td><td><span class="tag green">0</span></td><td></td><td>—</td></tr></tbody></table></div>
  ...
  <section class="sec">
    ...
    <hr>
    <div class="lead-table"><table><thead><tr><th>Contact</th><th>Address</th><th>Task</th><th>Assignee</th><th>Due</th></tr></thead><tbody><tr><td><strong>Mlm-Property Group Llc</strong></td><td>121 77TH ST</td><td>Call Mlm-Property Group Llc - 121 77TH ST, north bergen NJ  - (973) 674-7800</td><td><span class="tag">Jeff</span></td><td>Jun 10, 12:45 PM</td></tr>
...
new Chart(document.getElementById('stageChart'), {
  type: 'doughnut',
  data: { labels: ["1. Qualified", "2. LAO", "3. Due Diligence", "4. MAO", "Follow Up 1.5mo", "Follow Up 3mo", "Dead Deals"], datasets: [{ data: [20, 5, 7, 5, 10, 2, 30], backgroundColor: palette, borderWidth: 2, borderColor: '#FFFCF4' }] },
  options: { plugins: { legend: { position: 'bottom', labels: { padding: 12, usePointStyle: true, color: '#455066' } } }, cutout: '65%' }
});

new Chart(document.getElementById('stateChart'), {
  type: 'bar',
  data: { labels: ["NJ", "AL", "PA", "OH", "MI", "SC"], datasets: [{ data: [45, 14, 13, 5, 1, 1], backgroundColor: '#C9A52A', borderRadius: 4 }] },
...
new Chart(document.getElementById('progressChart'), {
  type: 'bar',
  data: { labels: ['0','1','2','3','4','5','6'], datasets: [{ label: 'Contacts', data: [49, 28, 1, 0, 1, 0, 0], backgroundColor: '#1A2840', borderRadius: 4 }] },
  options: { plugins: { legend: { display: false } }, scales: { y: { beginAtZero: true, ticks: { precision: 0, color: '#6B7591' }, grid: { color: 'rgba(26,40,64,0.06)' } }, x: { ticks: { color: '#455066' }, grid: { display: false } } } }
});
...
<div class="shell">
  ...
  <div class="paused-banner">SMS sends are <strong>PAUSED</strong> per APG Q2 strategy. Test infrastructure is fully wired — variant assignment, outcome tracking, and dashboard rendering all run. Flip <code>o2_test_config.json::global.sms_paused</code> to <code>false</code> to begin firing sends. Variant assignments computed during the pause are deterministic and survive the flip.</div>
    ...
    <div class="sig">
      ...
      <table class="sig-table">
        ...
        <tbody><tr><td><strong>A</strong></td><td>33.0%</td><td>31.9%</td></tr><tr><td><strong>B</strong></td><td>33.6%</td><td>35.0%</td></tr><tr><td><strong>C</strong></td><td>33.4%</td><td>33.0%</td></tr></tbody>
      </table>
  ...
  <div class="foot">Generated 2026-06-10T21:29:10.495669+00:00 · sms_test_dashboard.py</div>
</div>
</body>
</html>`,
