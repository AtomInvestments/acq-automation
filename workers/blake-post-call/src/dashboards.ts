...
<div class="shell">
  ...
  <header class="masthead">
    <div class="brandrow">
      ...
      <span>Updated May 27, 2026 · 04:37 PM ET</span>
    </div>
  ...
  <div class="summary-row">
      ...
      <div class="summary-kpi live"><div class="label">Overall Completion</div><p class="v">69<small>%</small></p></div>
      <div class="summary-kpi"><div class="label">Tasks Done</div><p class="v">44<small> / 63</small></p></div>
      <div class="summary-kpi live"><div class="label">Active Pillars</div><p class="v">4</p></div>
      <div class="summary-kpi warm"><div class="label">In Progress</div><p class="v">0</p></div>
      <div class="summary-kpi"><div class="label">Planned</div><p class="v">1</p></div>
    ...
    <section class="pillar">
      <div class="pillar-header">
        ...
        <div>
          ...
          <div class="progress-label">14 / 16 done · 87%</div>
        </div>
      </div>
...
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Property-type filter: SFR + multi + townhouse allowed; block condo / co-op / apartment / manufactured / mobile" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Property-type filter: SFR + multi + townhouse allowed; block condo / co-op / apartment / manufactured / mobile</span></li>
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="SMS message: Mike-with-APG B2B template (&#x27;active buyer backed by private capital&#x27;, signed Mike) — single variant per user direction" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">SMS message: Mike-with-APG B2B template (&#x27;active buyer backed by private capital&#x27;, signed Mike) — single variant per user direction</span></li>
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Title-case realtor name (VEERA BODAVULA → Veera Bodavula) for SMS + opp name + GHL contact" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Title-case realtor name (VEERA BODAVULA → Veera Bodavula) for SMS + opp name + GHL contact</span></li>
<li class="task done" data-pillar-id="pillar-b-listing-pipeline" data-task-label="Strip &#x27;Sq Ft&#x27; / &#x27;bd&#x27; metadata prefix from parsed street address (fixes &#x27;604 Sq Ft 544 Westgate Dr&#x27; bug)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Strip &#x27;Sq Ft&#x27; / &#x27;bd&#x27; metadata prefix from parsed street address (fixes &#x27;604 Sq Ft 544 Westgate Dr&#x27; bug)</span></li>
    ...
    <section class="pillar">
      <div class="pillar-header">
        ...
        <div>
          ...
          <div class="progress-label">5 / 9 done · 55%</div>
        </div>
      </div>
      <p class="summary">Every conversation live-syncs to APG-Vault as markdown via Worker → KV queue → local Python daemon. Manual self-improvement loop: Claude Opus reviews recent transcripts on demand, writes proposed prompt edits into vault for Mike to batch-apply.</p>
      <ul class="tasks">
        <li class="task done" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="Vault sync: Blake calls + landing leads + listings + GHL messages → APG-Vault markdown (live since 2026-05-26)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Vault sync: Blake calls + landing leads + listings + GHL messages → APG-Vault markdown (live since 2026-05-26)</span></li>
...
<li class="task done" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="Self-improvement trigger: manual POST /admin/blake/self-improve?sample=N (Adam vetoed full automation; manual batching per May 26 meeting)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Self-improvement trigger: manual POST /admin/blake/self-improve?sample=N (Adam vetoed full automation; manual batching per May 26 meeting)</span></li>
<li class="task done" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="Claude Opus 4.7 prompt-iteration loop: reviews recent calls + writes proposed edits to _system/Blake/iterations/" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Claude Opus 4.7 prompt-iteration loop: reviews recent calls + writes proposed edits to _system/Blake/iterations/</span></li>
...
<li class="task" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="Auto-promote winning version (DEFERRED — Adam vetoed in May 26 meeting; manual apply only)" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Auto-promote winning version (DEFERRED — Adam vetoed in May 26 meeting; manual apply only)</span></li>
...
<li class="task done" data-pillar-id="pillar-c-vault-self-improvement" data-task-label="Local vault-sync daemon installed as Windows scheduled task (APGVaultSync, restart-on-failure)" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">Local vault-sync daemon installed as Windows scheduled task (APGVaultSync, restart-on-failure)</span></li>
      </ul>
    </section>
...
<li class="task" data-pillar-id="pillar-d-training-videos" data-task-label="Vault output: per-video markdown wrapper" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">Vault output: per-video markdown wrapper</span></li>
    ...
    <section class="pillar">
      <div class="pillar-header">
        ...
        <div>
          <div class="progress-bar"><div class="fill" style="width:69%"></div></div>
          <div class="progress-label">9 / 13 done · 69%</div>
        </div>
      </div>
...
<li class="task" data-pillar-id="infrastructure" data-task-label="CF Workers Builds → auto-deploy on push (BROKEN — bypassed via direct \`wrangler deploy\` with CF API token)" tabindex="0" role="checkbox" aria-checked="false"><span class="checkbox"></span><span class="label">CF Workers Builds → auto-deploy on push (BROKEN — bypassed via direct \`wrangler deploy\` with CF API token)</span></li>
<li class="task done" data-pillar-id="infrastructure" data-task-label="CF Worker secrets: BLAKE_GHL_PIT, ELEVENLABS_API_KEY, ELEVENLABS_WEBHOOK_SECRET, ANTHROPIC_API_KEY, TWILIO_*, SLACK_BOT_TOKEN, WP_AUTH_HEADER, ATTOM_API_KEY, DASHBOARD_*, VAULT_SYNC_TOKEN" tabindex="0" role="checkbox" aria-checked="true"><span class="checkbox"></span><span class="label">CF Worker secrets: BLAKE_GHL_PIT, ELEVENLABS_API_KEY, ELEVENLABS_WEBHOOK_SECRET, ANTHROPIC_API_KEY, TWILIO_*, SLACK_BOT_TOKEN, WP_AUTH_HEADER, ATTOM_API_KEY, DASHBOARD_*, VAULT_SYNC_TOKEN</span></li>
...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Property Group · ACQ Operations</span>
      <span>Last updated May 27, 2026 04:37 PM ET</span>
    </div>
...
<div class="container">
  ...
  <details class="run-grid-collapsed"><summary>All 5 cron jobs OK on last run — click for timestamps</summary><div class="run-grid"><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ Call Recording Automation</span><span class="run-ts">May 27, 03:52 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ SMS Follow-Up + Dashboard</span><span class="run-ts">May 27, 08:34 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">APG Slack Scraper</span><span class="run-ts">May 27, 08:37 AM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">dashboard (script)</span><span class="run-ts">May 27, 04:36 PM</span><span class="run-detail">dashboard updated</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">sms (script)</span><span class="run-ts">May 27, 04:36 PM</span><span class="run-detail">{&quot;skipped-tag-prebail&quot;: 55, &quot;wait&quot;: 18, &quot;skipped&quot;: 5, &quot;no-phone&quot;: 1}</span></div></div></details><div class="status-banner on"><div class="status-text"><span class="pulse"></span>SMS Automation: <span style="color:var(--green);font-weight:800">ACTIVE</span></div><a class="btn btn-kill" href="https://docs.google.com/spreadsheets/d/1wc3Pt46ze-ejLaryL8WIRQf4OjEkirolc4-O8lsRQZY/edit#gid=0" target="_blank">EMERGENCY KILL SWITCH</a></div>
...
new Chart(document.getElementById('progressChart'), {
  type: 'bar',
  data: { labels: ['0','1','2','3','4','5','6'], datasets: [{ label: 'Contacts', data: [53, 23, 3, 0, 0, 0, 0], backgroundColor: '#1A2840', borderRadius: 4 }] },
  options: { plugins: { legend: { display: false } }, scales: { y: { beginAtZero: true, ticks: { precision: 0, color: '#6B7591' }, grid: { color: 'rgba(26,40,64,0.06)' } }, x: { ticks: { color: '#455066' }, grid: { display: false } } } }
});
