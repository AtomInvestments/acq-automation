...
<div class="container">
  ...
  <header class="masthead">
    <div class="brandrow">
      <span class="brand">Atom Investments · APG Operations</span>
      <span>Last updated Jun 12, 2026 08:05 PM ET</span>
    </div>
...
<div class="container">
  ...
  <div class="status-banner failure"><div class="status-text">⚠ <strong>1 cron job(s) failed on their last run</strong> — automation is partially down.</div><a class="btn btn-edit" href="https://github.com/AtomInvestments/acq-automation/actions" target="_blank">VIEW LOGS</a></div><div class="run-grid"><div class="run-row"><span class="tag hot">FAILED</span><span class="run-name">Deploy apg-dashboard Worker</span><span class="run-ts">Jun 12, 05:15 PM</span><span class="run-detail">failure — see logs</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ Call Recording Automation</span><span class="run-ts">Jun 12, 07:04 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">ACQ SMS Follow-Up + Dashboard</span><span class="run-ts">Jun 12, 02:32 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">APG Slack Scraper</span><span class="run-ts">Jun 12, 02:32 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">Debug Twilio Call</span><span class="run-ts">Jun 12, 05:30 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">Weekly Analysis</span><span class="run-ts">Jun 12, 05:12 PM</span><span class="run-detail">success</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">dashboard (script)</span><span class="run-ts">Jun 12, 08:04 PM</span><span class="run-detail">dashboard updated</span></div><div class="run-row"><span class="tag green">OK</span><span class="run-name">sms (script)</span><span class="run-ts">Jun 12, 08:04 PM</span><span class="run-detail">outside business hours (hour=20 ET)</span></div></div><div class="status-banner on"><div class="status-text"><span class="pulse"></span>SMS Automation: <span style="color:var(--green);font-weight:800">ACTIVE</span></div><a class="btn btn-kill" href="https://docs.google.com/spreadsheets/d/1wc3Pt46ze-ejLaryL8WIRQf4OjEkirolc4-O8lsRQZY/edit#gid=0" target="_blank">EMERGENCY KILL SWITCH</a></div>
